...
export class XiaomiVacuumMapCardEditor extends LitElement implements LovelaceCardEditor {
    ...
    protected render(): TemplateResult | void {
        ...
        return html`
            <div class="card-config">
                ...
                <div class="values selection-controls-wrapper">
                    <mwc-button @click="${() => XiaomiVacuumMapCardEditor._copyConfig()}">
    ...
    private static _copyConfig(): void {
    ...
    private _showToast(text: string, icon: string, successful: boolean, additionalText = ""): void {
        ToastRenderer.showToast(this.shadowRoot,
            (v) => this._localize(v), "editor", text, icon, successful, additionalText);
    }
