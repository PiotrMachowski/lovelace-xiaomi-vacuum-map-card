...
| `modes` | `list` | `False` | `[go_to_target, app_zoned_clean, predefined_zones]` | List of displayed modes. Possible values: `go_to_target`, `app_zoned_clean`, `predefined_zones` |
| `default_mode` | `string` | `False` | - | Default selected mode. Possible values: `go_to_target`, `app_zoned_clean`, `predefined_zones` |
