...
This platform can be used to control vacuums using `vacuum.send_command` service.
...
* ### Room cleaning (`vacuum_clean_segment`)
  ...
  Used command: `app_segment_clean`
